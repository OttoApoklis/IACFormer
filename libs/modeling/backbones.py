...
class SGPBackbone(nn.Module):
    ...
    def __init__(
        ...
        self.stem_attention = nn.ModuleList()
        for idx in range(arch[1]):
            path_pdrop = 0.2
            print(path_pdrop)
            sgp_mlp_dim = n_embd * 2
            print(sgp_mlp_dim)
            downsample_type = 'max'
        ...
        for idx in range(arch[2]):
            ...
            self.embdsize = n_embd
            print(self.sgp_win_size)
            self.scale_factor = 2
            print(self.scale_factor)
            path_pdrop = 0.2
            print(path_pdrop)
            sgp_mlp_dim = n_embd * 3
            print(sgp_mlp_dim)
            # if(idx == 0):
            #
            # else:
    ...
    def forward(self, x, mask):
        ...
        for idx in range(len(self.stem)):
            ...
            x, mask = self.stem_attention[idx](x, mask)
        ...
        for idx in range(len(self.branch)):
            ...
            x, mask = self.branch_attention[idx](x, mask)
